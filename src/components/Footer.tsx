            ...
            <div className="absolute inset-0 bg-gradient-to-r from-amber-800/80 to-amber-900/80 rounded-3xl flex items-center justify-center">
              <div className="text-center text-white">
                ...
                <div className="flex flex-row gap-2 sm:gap-4 justify-center px-4">
                  <Link
                    href="#"
                    className="inline-flex items-center justify-center bg-black text-white px-2 sm:px-6 py-2 sm:py-3 rounded-lg hover:bg-gray-800 transition-all duration-300 flex-1 sm:flex-initial"
                  >
                    <div className="flex items-center space-x-1.5 sm:space-x-3">
                      <svg className="w-4 h-4 sm:w-8 sm:h-8 flex-shrink-0" viewBox="0 0 24 24" fill="currentColor">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-[10px] sm:text-base font-bold leading-tight">Google Play</div>
                      </div>
                    </div>
                  </Link>
                  ...
                  >
                    <div className="flex items-center space-x-1.5 sm:space-x-3">
                      ...
                      <div className="text-left">
                        ...
                        <div className="text-[10px] sm:text-base font-bold leading-tight">App Store</div>
                      </div>
                    </div>
                  </Link>
                </div>
